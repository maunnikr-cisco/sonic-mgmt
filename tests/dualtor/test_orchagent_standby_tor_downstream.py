...
def test_downstream_standby_mux_toggle_active(
    ...
    wait_until(MUX_STATUS_CHECK_TIMEOUT, MUX_STATUS_CHECK_INTERVAL, 10, lambda: check_mux_status(rand_selected_dut, "standby"))
    ...
    wait_until(MUX_STATUS_CHECK_TIMEOUT, MUX_STATUS_CHECK_INTERVAL, 10, lambda: check_mux_status(rand_selected_dut, "active"))
